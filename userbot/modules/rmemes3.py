...
async def _(event):
    ...
    if input_str == "neno":
        ...
        animation_chars = [
            "**NENO ADALAH OWNER DARI SEGALA OWNER DI TELEGRAM,KENALAN DULU SAMA OWNER NYA**"
            "**PAKINTAKI FAMILY NAMANYA NENO,ORANG YANG**"
            "**PALING BERKUASA DI SULAWESI,BTW KATA NENO**"
            "**ORANG YANG TINGGAL DILUAR SULAWESI BABU DIA AWOKAWOK,KALO**"
            "**PENGEN PC ITU SUSAH SUSAH BANGET DAH SERIUSSSS,INTINYA**"
            "**DIA OWNER DARI SEGALA OWNER DI TELEGRAM,SALAM PAKINTAKI DARI NENO**"]
